...
const FIELD_ALIASES: Record<ImportEntityType, FieldMapping> = {
  ...
  parties: {
    name: ["name", "ten", "tên", "party_name", "tên công ty", "ten cong ty", "shipper", "consignee", "cnee"],
    code: ["code", "ma", "mã", "mã đối tác"],
    tax_code: ["tax_code", "mst", "mã số thuế", "vat"],
    branch_name: ["branch_name", "chi nhánh", "kho", "warehouse"],
    contact_person: ["contact_person", "người liên hệ", "nguoi lien he", "contact"],
    contact_phone: ["contact_phone", "sđt liên hệ", "sdt lien he"],
    address: ["address", "địa chỉ", "dia chi"],
    phone: ["phone", "sdt", "điện thoại"],
    fax: ["fax"],
    email: ["email"],
    handling_instructions: ["handling_instructions", "chỉ dẫn", "hướng dẫn", "ghi chú hàng"],
  ...
  commodities: {
    name: ["name", "ten", "tên", "tên hàng", "ten hang", "nature of goods", "mô tả hàng"],
    code: ["code", "ma", "mã", "mã hàng", "ma hang"],
    english_name: ["english_name", "ten tieng anh", "tên tiếng anh", "nature of goods en"],
    category: ["category", "danh muc", "danh mục", "nhóm hàng", "nhom hang"],
    cargo_type: ["cargo_type", "loại hàng", "loai hang"],
    hs_code: ["hs_code", "hs", "mã hs", "ma hs"],
    default_packaging: ["default_packaging", "đóng gói", "dong goi", "quy cách"],
    temperature_range: ["temperature_range", "nhiệt độ", "nhiet do"],
    notes: ["notes", "ghi chú"],
  },
};
