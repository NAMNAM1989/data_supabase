...
export async function createParty(supabase: Supabase, input: PartyInput) {
  const { data, error } = await supabase
    ...
    .insert({
      ...
      handling_instructions: input.handling_instructions || null,
      status: input.status,
...
export async function updateParty(supabase: Supabase, id: string, input: PartyUpdateInput) {
  const { data, error } = await supabase
    ...
    .update({
      ...
      branch_name: input.branch_name === "" ? null : input.branch_name,
      contact_person: input.contact_person === "" ? null : input.contact_person,
      contact_phone: input.contact_phone === "" ? null : input.contact_phone,
      ...
      handling_instructions:
        input.handling_instructions === "" ? null : input.handling_instructions,
